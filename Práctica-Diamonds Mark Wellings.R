...
#
# Objetivo : realizar distintos tipos de an√°lisis estad√≠stico de sus variables para intentar
# averiguar alg√∫n tipo de comportamiento oculto aparentemente en los datos. 
#
# Para ello os marco los siguientes pasos: tipos de variables, medidas de posici√≥n central, medidas de dispersi√≥n, 
# distribuci√≥n y relaci√≥n entre ellas, m√°s an√°lisis de regresi√≥n
#
...
# table: anchura de la parte superior de diamante con relaciÛn al punto m·s ancho 
...
# An·lisis descriptivo de las variables: Tipo de variable, distribuciÛn y representaciÛn
# DetecciÛn de casos atÌpicos y su tratamiento
...
# DetecciÛn de casos atÌpicos y su tratamiento
##Cualquier valor fuera del intervalo (Q3 + 1.5 RIC, Q1 - 1.5 RIC) se considerar· valor atÌpico 
...
# valor teÛrico < valor del experimento
# -1.64493 < 0.3089877
# No se rechaza Ho, admitimos como correcta la especificaciÛn.
######


# 4: Relaciones entre las variables
# Muestra las relaciones que existen entre variables 
# (dependencia, anova, correlaciÛn)
...
# 5: An·lisis de regresiÛn
# Formular un modelo de regresiÛn y analiza los resultados
# Interpreta los coeficientes estandarizados de la regresiÛn
...
######
# Aplica una transformaciÛn a la regresiÛn y analiza los resultados.
